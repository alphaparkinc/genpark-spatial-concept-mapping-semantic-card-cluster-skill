# genpark-spatial-concept-mapping-semantic-card-cluster-skill
...
> **GenPark AI Agent Skill** -- Spatial concept mapping card cluster & thematic grouping (Heptabase style)
